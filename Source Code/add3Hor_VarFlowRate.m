function out = add3Hor_VarFlowRate(a,b,c)
%% Version and general code information
%Horizontal Adding V 1.0 Updated 2022-04-07
% Inputs 
    % Three 3D arrays
% Outputs
    %3D array
...
addMatrix = [reduceC, reduceB, reduceA]; % Horizontally concatenates the matrices together. The point of view is from the perspective of the extrudate.
